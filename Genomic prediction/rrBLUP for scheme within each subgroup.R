...
load("~/Desktop/Alfalfa_GWAS/20250313/Genomic prediction/Results/scheme within each subgroup/accuracy for check.RData")
d_check <- data.frame(accuracy_all)
load("~/Desktop/Alfalfa_GWAS/20250313/Genomic prediction/Results/scheme within each subgroup/accuracy for OTTM.RData")
d_OTTM <- data.frame(accuracy_all)
load("~/Desktop/Alfalfa_GWAS/20250313/Genomic prediction/Results/scheme within each subgroup/accuracy for SIBR.RData")
d_SIBR <- data.frame(accuracy_all)
load("~/Desktop/Alfalfa_GWAS/20250313/Genomic prediction/Results/scheme within each subgroup/accuracy for CASIA.RData")
d_CASIA <- data.frame(accuracy_all)
load("~/Desktop/Alfalfa_GWAS/20250313/Genomic prediction/Results/scheme within each subgroup/accuracy for EURO.RData")
...
load("~/Desktop/Alfalfa_GWAS/20250313/Genomic prediction/Results/scheme for entire pop/accuracy for entirePOP_5fold.RData")
...
# write.csv(All_combine,"Predictive_ability_all_subgroups.csv",row.names = F)
library(ggplot2)
png("~/Desktop/Alfalfa_GWAS/20250313/Genomic prediction/Results/within subgroup&entirePop_5fold3.png",height = 1500,width = 4500,res = 300)
